...
NetworkSettingsView::NetworkSettingsView(NetworkConfig *cfg, Device *dev, DeviceList &devList, QWidget *parent) :
    QDialog(parent), _devList(devList)
{
    _cfg = cfg;
    _dev = dev;
    setModal(true);
    ...
    QIcon icon;
    icon.addFile(QStringLiteral(":/icons/imgs/network.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QMetaObject::invokeMethod(this, "onViewInited", Qt::QueuedConnection);
}
