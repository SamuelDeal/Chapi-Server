...
ChapiView::ChapiView(ChapiDevice *dev, DeviceList &devList, QWidget *parent) :
    QIntegratedFrame(parent), _devList(devList), _netCfg(dev->networkConfig())
{
    _dev = dev;
    _target = NULL;
    ...
    QIcon icon;
    icon.addFile(QStringLiteral(":/icons/imgs/chapi.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon2;
    icon2.addFile(QStringLiteral(":/icons/imgs/network.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon iconOutput;
    iconOutput.addFile(QStringLiteral(":/icons/imgs/output.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon iconAdd;
    iconAdd.addFile(QStringLiteral(":/icons/imgs/add.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    content->setSizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::MinimumExpanding);
    QIcon iconInput;
    iconInput.addFile(QStringLiteral(":/icons/imgs/input.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    scrollArea = new QScrollArea();
    content = new QWidget();
    _faderLayout = new QVBoxLayout();
    content->setLayout(_faderLayout);
    content->setSizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::MinimumExpanding);
    QIcon iconFader;
    iconFader.addFile(QStringLiteral(":/icons/imgs/slider.png"), QSize(), QIcon::Normal, QIcon::Off);
    int tabIndex = _tabs->addTab(scrollArea, iconFader, tr("Faders"));
    scrollArea->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
    scrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
    scrollArea->setWidgetResizable(true);
    scrollArea->setWidget(content);
    if(_dev->faderCount() > 0){

    }
    else {
        _tabs->setTabEnabled(tabIndex, false);
    }
...
void ChapiView::onDeviceListChanged() {
    ...
    QIcon icon3;
    icon3.addFile(QStringLiteral(":/icons/imgs/vh.png"), QSize(), QIcon::Normal, QIcon::Off);
    QIcon icon4;
    icon4.addFile(QStringLiteral(":/icons/imgs/atem.png"), QSize(), QIcon::Normal, QIcon::Off);
