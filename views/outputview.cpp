    ...
    QFrame(parent)
{
    ...
    QIcon settingsIcon;
    settingsIcon.addFile(QStringLiteral(":/icons/settings.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon removeIcon;
    removeIcon.addFile(QStringLiteral(":/icons/remove.png"), QSize(), QIcon::Normal, QIcon::Off);
